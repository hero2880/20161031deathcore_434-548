...
public:
	...
	{
		if (player->pvpInfo.inHostileArea) //gets updated by UpdatePvPState
		{
	...
	void OnPVPKill(Player* killer, Player* victim)
	{
		...
		if (killer->pvpInfo.inHostileArea && victim->pvpInfo.inHostileArea) //gets updated by UpdatePvPState
		{
