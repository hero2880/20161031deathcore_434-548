...
extern int main(int argc, char **argv)
{
    ...
    //sLog->outInfo(LOG_FILTER_AUTHSERVER, "   ");                                                        
    //sLog->outInfo(LOG_FILTER_AUTHSERVER, "   ");                                                        
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "  	Noffearr Death ProjecT 2016(c) Open-Sourced Game Emulation"); 
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "		       http://www.noffearrdeathproject.org ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "   ");                                                        
    sLog->outInfo(LOG_FILTER_AUTHSERVER, "   ");                                                        
